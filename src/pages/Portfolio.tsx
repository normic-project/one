...
export default function PortfolioPage() {
  ...
  return <div className="page"><div className="page-heading heading-row"><div><span className="eyebrow">YOUR CONVICTION, IN VIEW</span><h1>Portfolio</h1><p>Your positions, orders, and activity.</p></div><button className="button secondary" disabled={loading} onClick={() => void refresh()}><RefreshCw size={15} />Refresh</button></div><StatusBanner />
