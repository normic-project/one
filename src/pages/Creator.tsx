...
export default function CreatorPage() {
  ...
  const claimDisplay = summaryState === 'success' ? exactUsdg(claimable) : summaryState === 'idle' ? '0.00' : placeholder;
  const createdDisplay = summaryState === 'success' ? String(markets.length) : summaryState === 'idle' ? '0' : placeholder;
  const volumeDisplay = summaryState === 'success' ? `$${money(totalVolume)}` : summaryState === 'idle' ? '$0.00' : placeholder;
  const showClaimUnit = summaryState === 'success' || summaryState === 'idle';
