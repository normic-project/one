...
function Home() {
  ...
  return <><section className="hero"><div className="hero-copy"><div className="hero-tag"><span className="tiny-dot" />BUILT ON ROBINHOOD CHAIN <ArrowUpRight size={13} /></div>
    ...
    <section className="principles"><article><span>01</span><h3>Conviction meets a counterparty.</h3><p>No house, no hidden liquidity. Your order fills when another trader takes the other side.</p></article><article><span>02</span><h3>Every outcome is fully backed.</h3><p>One USDG backs each matched YES/NO pair. Fees and resolution bonds remain separate.</p></article><article><span>03</span><h3>Rules set. Evidence settles.</h3><p>Automatic TWAP or bonded event resolution follows immutable terms. Creators cannot select winners.</p></article></section>
  </>;
}
